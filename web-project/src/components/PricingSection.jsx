...
const PricingSection = () => {
  ...
  // cal product price base on product count
        ...
        <div  className="max-w-xl mx-auto">
            ...
            <div className="relative px-4">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs sm:text-sm text-gray-600">{productCount}</span>
                </div>

                <div className="text-center mt-12">
                    <p className="text-xl text-gray-600 mt-4">Ready to get started?</p>
                    <button className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors cursor-pointer mt-3" >Get Started</button>
                </div>
