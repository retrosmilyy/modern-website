...
const Hero = () => {
  return (
    <section id="home" className="container mx-auto flex flex-col md:flex-row  justify-between items-center pt-44 pb-6 sm:px-6 lg:px-8">
      {/* left column */}
      <div className="w-full md:w-1/2 space-y-8">
        {/* star badge */}
        <div className="group flex items-center gap-2 bg-gray-100 w-fit  px-4 py-2 rounded-full hover:bg-gray-100 transition-colors cursor-pointer">
        ...
        <div className="flex gap-3 max-w-md">
          <input
            ...
            className="flex-1 px-6 py-4 border border-gray-200 rounded-xl focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-100"
          />
