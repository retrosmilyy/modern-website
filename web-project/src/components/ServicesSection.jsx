    ...
    >
      ...
      >
        ...
        >
          ...
          <motion.div variants={staggerContainer(0.2, 0.3)} className="space-y-3">
            <motion.div
        ...
        >
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-white max-w-72 cursor-pointer rounded-2xl p-6 hover:shadow-xl hover:scale-105 transition-all duration-300"
            >
